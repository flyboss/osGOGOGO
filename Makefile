...
CFLAGS		= -m32 -I include/ -I include/sys/ -c -fno-builtin -fno-stack-protector -fpack-struct -Wall
...
LOBJS		=  lib/syscall.o\
			...
			lib/lseek.o\
			lib/getpid.o lib/getticks.o lib/stat.o\
